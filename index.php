  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <div class="social-links">
        ...
        <a href="https://www.instagram.com/chengshin0722/" class="instagram"><i class="bx bxl-instagram"></i></a>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>關於我</h2>
          <p>我是誠信，於義守大學應數系畢業，學習財務分析及資訊科學等技能。並於2020退伍後，想學習寫程式，因而進入泰山職訓局接受920小時php資料庫網頁設計課程訓練，並且結訓拿到證書</p>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>網路管理員</h4>
              <h5>2020/10 - 2021/8</h5>
              <p><em>樂東股份有限公司 </em></p>
              <ul>
                <li>Google Cloud Platform架設伺服器</li>
                <li>使用wordpress架設網路商店 </li>
                <li>python機器學習(yolov4)</li>
                <li>python連接api美國股票</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>文書兵</h4>
              <h5>2015/12 - 2020/1</h5>
              <p><em>中華民國海軍陸戰隊</em></p>
              <ul>
                <li>使用word編輯資料</li>
                <li>使用excel的函式，讓連上作業更迅速</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  <a href="assets/img/hw/<?=$row['img']?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?=$row['intr']?>"><i class="bx bx-plus"></i></a>
                  <a href="./pro/<?=$row['loca']?>" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit">Send Message</p></button></div>
            </form>
